...
\ExeText{}
    ...
    \Question{Iterate over the files (See lecture slides: {\bf Iterating multiple files}) in folder `sample\_data/a\_folder' and print the file contents. \\{\bf Hint:} Remeber, the function {\tt open} takes the {\it full file path} as the first argument. To join locations as a path you can use {\tt `os.path.join`}
...
\subsection*{Advanced Questions: Reading and writing a csv file}
